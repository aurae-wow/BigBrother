...
X-ReleaseDate: $Date: 2012-09-04 02:29:48 +0000 (Tue, 04 Sep 2012) $
...
local MINOR_VERSION = 90000 + tonumber(("$Revision: 101 $"):match("(%d+)"))
...
function Lib:AceEvent_FullyInitialized()
	...
	self:RegisterBucketEvent({"GROUP_ROSTER_UPDATE"}, 0.2, "ScanFullRoster")
...
function Lib:ScanPet(owner_list)
	...
	for owner in pairs(owner_list) do
	    if LegitimateUnits[owner] then -- BigBrother ticket37, ignore boss pets
